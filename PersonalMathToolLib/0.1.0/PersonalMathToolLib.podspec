#
# Be sure to run `pod lib lint PersonalMathToolLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'PersonalMathToolLib'
  s.version          = '0.1.0'
  s.summary          = 'PersonalMathToolLib.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  # s.resource_bundles = {
  #   'PersonalMathToolLib' => ['PersonalMathToolLib/Assets/*.png']
  # }
